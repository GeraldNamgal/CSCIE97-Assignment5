...
public class CommandProcessor
{
    ...
    public void parseAndProcess(String line)
    {
        ...
        if ((splitStringArr.length == 2) && splitStringArr[0].equalsIgnoreCase("create-account"))
        {           
            System.out.println("-: " + trimmedLine);
        ...
        else if ((splitStringArr.length == 2) && splitStringArr[0].equalsIgnoreCase("get-account-balance"))
        {            
            System.out.println("-: " + trimmedLine);
        ...
        else if ((splitStringArr.length == 1) && splitStringArr[0].equalsIgnoreCase("get-account-balances"))
        {            
            System.out.println("-: " + trimmedLine);
            getAccountBalances();
            System.out.println();            
        ...
        else if ((splitStringArr.length == 2) && splitStringArr[0].equalsIgnoreCase("get-block"))
        {           
        ...
        else if ((splitStringArr.length == 2) && splitStringArr[0].equalsIgnoreCase("get-transaction"))
        {            
            System.out.println("-: " + trimmedLine);
        ...
        else if ((splitStringArr.length == 1) && splitStringArr[0].equalsIgnoreCase("validate"))
        {            
            System.out.println("-: " + trimmedLine);
            validate();
            System.out.println();            
        ...
        else if ((splitStringArr.length == 1) && splitStringArr[0].equalsIgnoreCase("get-total-blocks"))
        {           
            System.out.println("-: " + trimmedLine);
            totalNumBlocks();
            System.out.println();            
